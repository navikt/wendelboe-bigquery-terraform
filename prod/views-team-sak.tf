resource "google_bigquery_dataset" "saksbehandlingsstatistikk_til_team_sak_dataset" {
  ...
  access {
    role          = "READER"
    user_by_email = "pensjon-ptsak-reader@ptsak-prod-1ff7.iam.gserviceaccount.com"
  }
  timeouts {}
}
...
resource "google_bigquery_table_iam_binding" "behandlingshendelse_alder_view_iam_binding" {
  ...
  role       = "roles/bigquery.dataViewer"
  members    = ["serviceAccount:pensjon-ptsak-reader@ptsak-prod-1ff7.iam.gserviceaccount.com"]
}
